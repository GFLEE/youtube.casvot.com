...
// echo "<script src="./inc/progress.js"></script>";
...
<div class="container d-lg-none d-md-none p-0">
 ...
 ?>
  ...
  <div class="container py-2">
    ...
    "> 
   <h3 class="pt-5 pb-2 text-white">Advanced Search</h3>
    <form>
  <div class="form-group" >
      <input type="text" name="v" style="width: 50%;height: 50px;border: none;box-sizing: border-box;padding: 14px 18px;border-radius:6px  0 0 6px ;" placeholder="Video ID or Youtube address"  autocomplete="off" /><button type="submit"  style="width: 18%;border: none;height: 50px;background-color: #e62117;color: #fff;font-size: 18px;display: inline-block;cursor:pointer;border-radius:0 6px 6px 0" ><i class="fa fa-youtube-play fa-lg pr-1" style="cursor:pointer"></i>Play</button>
  </div>
    </form>
    ...
    <div class="col-8 sm-p">
      <span class="txt2 ricon h5">Pupular</span>
    </div>
