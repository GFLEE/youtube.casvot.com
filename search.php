  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
          <br>
          <span class="txt2 pt-1 pb-1" style="text-align: left;display:block;">Search results with :&nbsp;<b style="font-size:26px;font-family:Arial,Verdana,Sans-serif;"><?php echo $_GET["q"] ?></b></span>
       <div class="row"> <div class="col-md-12 selectalign">  Options： <select class="custom-select" id="paixu">
        <?php
             switch ($order1){
                    case 'relevance':
                      $relevance='selected';
             ...
             echo '<option '.$viewCount.' data-url="./ajax/ajax.php?q='.$q.'&type=video&order=viewCount&ptk='.$_GET['pageToken'].'">Sort by Views</option>';
             echo '<option '.$channel.' data-url="./ajax/ajax.php?q='.$q.'&type=channel&order=relevance&ptk='.$_GET['pageToken'].'">Only search channels</option>';
        ?>
          </select></div></div>
